    ...
    <div className="page-content">
      ...
      <section className="page-section">
        ...
        <p className="section-text">
          ...
          people to come up and showcase what they've got! So, let's meet soon!
        </p>
      </section>
      <section className="page-section">
        ...
        <p className="section-text">
          ...
          Event, the audience will get to level up yet again! Listen to the top
          notch speakers on some of the hot topics in the cyber security domain
          and enjoy the CTF hosted by us from the comfort from your home.
        </p>
      </section>
            ...
            {team.map((member) => {
              return (
                <div className="card team" key={member.id}>
                  <img src={member.imgURL} alt={member.id} className="avatar" />
